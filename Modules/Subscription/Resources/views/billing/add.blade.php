...
<div class="mb-1 mt-2">
    <ul class="breadcrumb">
        ...
        <li class="mx-1">/</li>
        <li class="active">Add Billings</li>
    </ul>
</div>
          ...
          <table id="ThemeTable" class="table table-bordered projects">
            ...
            <tbody>
              <tr>
                ...
                <td></td>
                <td></td>
                <td> <a href="" title="edit post" class="btn btn-bg" data-method="Edit" data-trigger-confirm="1" data-pjax-target="#user-grid"><i class="fa fa-pencil"></i></a>
