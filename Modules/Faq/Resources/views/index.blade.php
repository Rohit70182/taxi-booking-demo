                        ...
                        <table class="table table-striped table-hover" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $faq->question }}</td>
                                    <td class="actions">
                                        <form action="{{ route('faq.destroy') }}" method="POST" onsubmit='return confirm("are you sure ?")'>
                                            <a class="btn-success btn" href="{{ route('faq.show',$faq->id) }}"><i class="fa fa-fw fa-eye"></i></a>
                                            <a class="btn btn-bg " href="{{ route('faq.edit',$faq->id) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                            @csrf
                                            @method('DELETE')
